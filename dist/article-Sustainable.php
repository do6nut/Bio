...
<body>
                  ...
                  <div class="navbar-dropdown-menu-inner">
                    <div class="row">
                      <div class="col-sm-5 col-lg-3">
                        ...
                        <a class="dropdown-item " href="article-Industry.php?id=19">Dairy and beef industry</a>
                        <a class="dropdown-item " href="article-Industry.php?id=20">Aquaculture industry</a>
  ...
  $sql = "SELECT * FROM article WHERE article_id = $id AND article_type = 'SUSTAINABLE'";
