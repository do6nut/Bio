    ...
    <div class="container content-space-t-3 content-space-t-lg-4 content-space-b-2 content-space-b-lg-3 overflow-hidden">
      ...
      <div class="">
        ...
        <div class="w-lg-65 text-center mx-lg-auto mb-5 mb-sm-7 mb-lg-7">
          <h2>Customer and social feedback</h2>
        </div>
        <!-- End Heading -->
        ...
        <div class="row row-cols-2 row-cols-sm-2 row-cols-md-4">
          ...
          $sql = "SELECT * FROM article WHERE article_type = 'Customer Feedback' ORDER BY article_Timestamp DESC";
                ...
                <!-- Media -->
                  <div class="d-sm-flex align-items-sm-center">
                      <div class="flex-grow-1 ms-sm-3">
                          <a class="nav-link " href="<?= $row['article_ConEn1'] ?>">
                              <h6 class="mb-0"><?= $row['article_Header'] ?></h6></a>
                      </div>
                  </div>
              </div>
                <!-- End Media -->
