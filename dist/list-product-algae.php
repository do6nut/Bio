    ...
    <div class="overflow-hidden">
      <div class="container content-space-t-3 content-space-t-lg-4 content-space-b-1 content-space-b-lg-2">
        <div class="w-lg-50 text-center mx-lg-auto">
          <!-- Heading -->
          <div class="mb-5">
            <h1 class="display-4">Spirulina and Algae</h1>
          </div>
          <!-- End Heading -->
        </div>
      </div>
    ...
    <div class="container content-space-b-2 content-space-b-lg-3 overflow-hidden">
      <div class="row row-cols-1 row-cols-sm-2 gx-7">
          ...
          <?php
              ...
              $sql = "SELECT * FROM article WHERE artcle_type = 'ALGAE' ";
          ...
          <?php while ($row = $result->fetch_assoc()) : ?>
            ...
            <div class="col mb-7 mb-md-10">
                <!-- Card -->
                <a class="card card-ghost h-100" href="article-Algae.php?id=<?= $row['article_id'] ?>">
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            ...
                            <p class="card-text"><?= $row['article_ConEn1'] ?></p>
...
<footer>
  <div class="bg-img-start position-relative">
    <img class="img-fluid" src="./assets/img/BioShine/barfooter.png"
         style="width: 6000px; height: 15px;">
  </div>
  <!-- End Col -->
  </div>
</footer>
    ...
    <div class="row align-items-md-center text-center text-md-start">
      <div class="col-md mb-1 mb-md-0">
        ...
        <a class="g-text-underline--none--hover mr-4" href="index.html">
          <img class="img-fluid" src="./assets/img/logo/BS.png"
