              ...
              <div class="card card-shadow">
                <div class="card-body p-sm-7 p-md-5">
                  ...
                  <form action="article_update.php" method="post" enctype="multipart/form-data">
                    ...
                    $sql = "SELECT * FROM article WHERE article_type = 'Customer Feedback' and article_id = $id";
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" name="article_Header"
                             value="<?= $row['article_Header'] ?>" placeholder="">
                    </div>
