    ...
    <div class="navbar-sidebar-aside-content content-space-1 content-space-md-2 px-lg-5 px-xl-10">
        ...
        <div class="docs-page-header">
            <div class="row align-items-center">
                <div class="col-sm">
                    <h1 class="docs-page-header-title">Development</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
                    ...
                    <div class="w-lg-75 mx-lg-auto">
                        ...
                        <div class="card card-shadow">
                            <div class="card-body p-sm-7 p-md-5">
                                ...
                                <form action="../admin/insert_db_development.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-5">
                                    <h4 class="card-title">List of Development</h4>
                                </div>
                                ...
                                <table class="table table-sm">
                                    ...
                                    $sql = "SELECT pc.Type AS Type
                                            FROM productcategory pc
                                            WHERE GroupType = 'SUSTAINABLE' 
                                            ORDER BY Type ASC";
...
<script>
    ...
    function chkConfirm(i)
    {
        ...
        {
            window.location.href="del-development.php?id="+i;
        }
        else
        {
