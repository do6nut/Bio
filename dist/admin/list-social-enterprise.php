                ...
                <div class="card-body p-sm-7 p-md-5">
                  ...
                  <div class="mb-5">
                    <h4 class="card-title">
                            ...
                            List of Social enterprise    </h4>

                      <ul class="nav justify-content-end " role="tablist">
                          <li class="nav-item">
                              <a href="../admin/add-social-enterprise.php" type="submit" class="btn btn-primary  btn-sm">
                                  <i class=" bi-plus"></i>
                                  Add</a>
                ...
                Delete</a> -->
                  ...
                  <table class="table table-sm">
                    ...
                    <tbody>
                      ...
                      $sql = "SELECT * FROM article WHERE article_type = 'Social enterprise'";
                      $result = $conn->query($sql);
                      ...
                      <?php while ($row = $result->fetch_assoc()) : ?>
                        <tr>
                          ...
                          <th scope="row"><?php echo $row['article_Header']; ?></th>
                          <th style="width: 1rem;">
                              <a href="edit-social-enterprise.php?id=<?php echo $row['article_id']; ?>"
                                 type="button" class="btn btn-soft-success btn-sm "><i class="bi bi-pencil-square"></i>
                              </a>
                          </th>
                          <th style="width: 1rem;">
                              <a href="del-social-enterprise.php?id=<?php echo $row['article_id']; ?>"
                                 type="button" class="btn btn-danger btn-sm "><i class="bi bi-x-lg"></i>
                              </a>
                          </th>
                        </tr>
                      <?php endwhile ?>
