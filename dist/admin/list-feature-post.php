    ...
    <div class="navbar-sidebar-aside-content content-space-1 content-space-md-2 px-lg-5 px-xl-10">
      ...
      <div class="docs-page-header">
        <div class="row align-items-center">
          <div class="col-sm">
            <h1 class="docs-page-header-title">Feature post</h1>
          </div>
        </div>
      </div>
      <!-- End Page Header -->
                ...
                <div class="card-body p-sm-7 p-md-5">
                  ...
                  <div class="mb-5">
                    <h4 class="card-title">
                            ...
                            List of Feature post   </h4>

                      <ul class="nav justify-content-end " role="tablist">
                          <li class="nav-item">
                              <a href="../admin/add-feature-post.php" type="submit" class="btn btn-primary  btn-sm">
                                  <i class=" bi-plus"></i>
                                  Add</a>
                              <?php
                              $id = 0;
                ...
                Delete</a> -->
                  ...
                  <table class="table table-sm">
                    ...
                    <tbody>
                      ...
                      $sql = "SELECT * FROM article WHERE article_type = 'featurepost'";
