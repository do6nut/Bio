            ...
            <div class="w-lg-75 mx-lg-auto">
              ...
              <div class="card card-shadow">
                <div class="card-body p-sm-7 p-md-5">
                    ...
                    ?>
                  <form action="insert_db_sub_product_category.php" method="post" enctype="multipart/form-data">

                      <div class="mb-3" style="display: none">
                          <label class="form-label">Header123</label>
                          <input type="text" class="form-control" name="header_Id" placeholder="" value="<?=$id?>">
                      </div>
