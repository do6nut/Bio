            ...
            <div class="w-lg-75 mx-lg-auto">
              ...
              <div class="card card-shadow">
                <div class="card-body p-sm-7 p-md-5">
                  ...
                  <form action="update_db_banner.php" method="post" enctype="multipart/form-data">
                    <?php
                    ...
                    $sql = "SELECT * FROM article WHERE article_tag = '$id' ";
                    ...
                    <div class="mb-3">
                      ...
                      <div class="mb-3">
                          <label for="careersApplyFormFile" class="js-file-attach form-label" data-hs-file-attach-options='{
                               ...
                               }'>Select image for upload banner</label>
                          <input class="form-control" type="file" id="careersApplyFormFile" name="Banner_Img" >
                          <span><?= $row['article_Image_1'] ?></span>
                      </div>
                    ...
                    <div class="mb-3">
                      <label class="form-label">Link to page</label>
                        ...
                        $sql2 = "SELECT article_ConEn1 FROM article WHERE article_type = 'Banner' and article_tag = '$id'";
                        ...
                        <select name="value">
                              <?php while ($row = $result->fetch_assoc()) : ?>
                                  <option
                                  <?php echo $row['article_Header'] == $row2['article_ConEn1'] ? "Selected" : ""; ?>>
                                      <?php echo $row['article_Header']; ?>
                                  </option>
