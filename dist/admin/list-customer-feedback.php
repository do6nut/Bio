    ...
    <div class="navbar-sidebar-aside-content content-space-1 content-space-md-2 px-lg-5 px-xl-10">
      ...
      <div class="docs-page-header">
        <div class="row align-items-center">
          <div class="col-sm">
            <h1 class="docs-page-header-title">Customer & Social feedback</h1>
          </div>
        </div>
      </div>
      <!-- End Page Header -->
                ...
                <div class="card-body p-sm-7 p-md-5">
                  ...
                  <div class="mb-5">
                    <h4 class="card-title">
                            ...
                            List of Customer and Social feedback    </h4>

                      <ul class="nav justify-content-end " role="tablist">
                          <li class="nav-item">
                              <a href="../admin/add-customer-feedback.php" type="submit" class="btn btn-primary  btn-sm">
                                  <i class=" bi-plus"></i>
                                  Add</a>
                              <?php
                              $id = 0;
                ...
                Delete</a> -->
                  ...
                  <table class="table table-sm">
                    ...
                    <tbody>
                      ...
                      $sql = "SELECT * FROM article WHERE article_type = 'Customer Feedback'";
                      ...
                      <?php while ($row = $result->fetch_assoc()) : ?>
                        <tr>
                          ...
                          <th style="width: 1rem;">
                              <a href="edit-customer-feedback.php?id=<?php echo $row['article_id']; ?>"
                          ...
                          <th style="width: 1rem;">
                              <a
                                    ...
                                    OnClick="chkConfirm('<?php echo $row['article_id']; ?>')">
